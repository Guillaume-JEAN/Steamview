...
class MesWish extends StatefulWidget {
  @override
  _MesWishState createState() => _MesWishState();
}
class GameDetails {
  final String name;
...
class _MesWishState extends State<MesWish> {
  @override
      ...
      body: StreamProvider<AppUserData>.value(
        ...
        child: Consumer<AppUserData>(
          builder: (context, userData, child) {
            return userData.wishlist.isEmpty
                ? Center(
              child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child: FutureBuilder<GameDetails>(
                          future: fetchDetails(userData.wishlist[index]),
                              ...
                              return Container(
                                ...
                                child: ListTile(
                                  ...
                                  trailing: SizedBox(
                                    ...
                                    child: TextButton(
                                      onPressed: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => Details(appID: userData.wishlist[index])));
                                      },
                                      child: Column(
                                        children: [
                                          Text('En savoir plus',
